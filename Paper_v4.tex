...
First, while the C3a trend was captured, the overall level of C3a was consistently under-predicted in all cases (Fig. \ref{fig-prediction}, left column).
We believe the C3a under-prediction was related to how we modeled C4BP interactions;
...
Second, while the C5a measurements were within the 95\% confidence estimate, we failed to capture the concave down curvature for the 0.001~g and 0.01~g zymosan cases.
