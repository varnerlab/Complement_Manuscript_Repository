...
We perturbed each pairwise combination of parameters by 10\%, and calculated the distance between the perturbed and nominal state for each parameter set in the ensemble.
...
To more closely simulate a clinical intervention e.g., administration of anti-complement inhibitors, we performed robustness analysis in the absence and presence of flow.
...
\subsection*{Complement model analysis.}
