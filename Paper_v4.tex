...
Only dual dual-knockdown of C3 and C5 consistently reduced C3 and C5a formation when all pathways were activated.
...
For example, complement contributes to tissue homeostasis \cite{ricklin2010complement}, and has also been linked with several diseases including Alzheimers, Parkinson's, multiple sclerosis, schizophrenia, rheumatoid arthritis and sepsis \cite{ricklin2007complement, rittirsch2008harmful}.
...
However, despite its importance, there have been relatively few approved complement specific therapeutics.

The complement cascade involves many soluble and cell surface proteins, receptors and regulators.
...
Thus, reduced order modeling approaches, which describe the key biology of complement using a limited number of parameters, will be important for developing validated models of complement, and to fully understanding its role in the body.
...
The cyclic peptide inhibitor Compstatin and its derivatives, which target C3, are promising approaches for the treatment of X, Y and Z [FINISH] \cite{Mastellos:2015aa}.
...
Thus, inclusion of this pathway could be important for understanding the role of MASP-1/2 inhibitors on complement model performance.
