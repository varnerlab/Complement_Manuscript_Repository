...
In this study, we perturbed the initial condition of C3 or C5 or a combination of C3 and C5 by 50\% or 90\% and measured the AUC of C3a or C5a with and without lectin initiator.
Robustness coefficients were calculated for every member of the ensemble, the mean $\pm$ 1$\times$standard-deviation are reported.
