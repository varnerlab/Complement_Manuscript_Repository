...
Pathways involving sensitive parameters have been targeted for clinical intervention (Fig. \ref{fig-SA}E).
However, sensitivity coefficients are only a local measure of how small changes in a parameter value affects model performance.
...
\textbf{A}: Sensitivity of the C3a residual at w/o zymosan,
\textbf{B}: Sensitivity of the C5a residual at w/o zymosan,
