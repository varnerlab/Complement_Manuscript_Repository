...
In the absence of zymosan, the tickover parameters were important to both C3a and C5a formation, but C5a was also sensitive to both AP C3 and C5 convertase activity.
...
robustness analysis on the model ensemble.
