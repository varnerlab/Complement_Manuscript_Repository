...
\caption{Pairwise sensitivity and clustering of complement model parameters.
The response of the complement model was calculated for each parameter combination following a 10\% increase in a model parameter in the presence of 1 mg/ml zymosan.
The model response was clustered into high (black), medium (gray) and low (white) response based upon the euclidian distance. The blue group of parameters are the most sensitive while
the parameters in the green cluster are the least sensitive.
