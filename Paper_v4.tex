...
Complement is mediated by over 30 soluble and cell surface proteins and regulators.
The molecular connectivity of complement is complex, and has been extensively reviewed by Walport \cite{Walport:2001ab,Walport:2001aa}.
The central outputs of complement are the Membrane Attack Complex (MAC), and the inflammatory mediators C3a and C5a.
The membrane attack complex forms transmembrane channels which disrupt the membrane integrity of targeted cells, leading to cell lysis and death.
On the other hand, the C3a and C5a proteins act as a bridge between innate and adaptive immunity, and play an important role in regulating inflammation and coagulation in the case of C5a \cite{sarma2011complement}.
...
The C4a and C2b fragments combine to form the C4bC2a protease, which is also known as the classical C3 convertase.
...
These complexes also cleave C4 and C2, leading the formation of additional classical C3 convertase.
Thus, the classical and lectin pathways converge at the classical C3 convertase, and are initiated by the recognition of a foreign surface.
However, the final pathway, known as the alternate pathway, works differently.
...
C3w recruits factor B and factor D, leading to the formation of C3wBb which cleaves C3 into C3a and C3b.
The C3b fragment can further recruit additional factor B and factor D to form C3bBbC3b, otherwise known as the alternate C3 convertase \cite{pangburn1984alternative}.
The role of classical and alternative C3 convertases is varied.
First, the C3 convertases encode an amplification loop by cleaving C3 into C3a and C3b, the latter is then free to form additional alternate C3 convertase.
Next, they link complement initiation with the terminal response of the cascade through the formation of C5 convertases.
The classical and alternate C3 convertases recruit C3b, form the classical C5 convertase (C4bC2aC3b), and alternate C5 convertase (C3bBbC3b) respectively.
The C5 convertases cleave C5 to form the C5a and C5b fragments.
