...
\subsection*{Formulation of the reduced order complement model.}
...
For the alternative pathway, we used the C3a and C5a measurements of Morad and coworkers \cite{morad2015time} in the absence of zymosan, and only allowed the alternative parameters to vary (Fig. \ref{fig-fit} A and B).
...
The reduced complement model captured the behavior of the alternative and lectin pathways (Fig. \ref{fig-fit}).
Taken together, the reduced order approach reproduced a panel of lectin pathway initiation data sets in the neighborhood of physiological factor and inhibitor concentrations.
